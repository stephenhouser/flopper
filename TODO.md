...
- ✅ Position labeling refactored: removed `positionLabel` and `isDealer` from Player class; added `labelsForPosition()` utility; `dealerPosition` is now explicit game state parameter; all tests passing.
