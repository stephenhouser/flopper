...
const PlayerRowComponent = React.memo(
  ({ player, isCompact = Platform.OS !== "web", showScore, heroScore, showAllCards, revealed, onToggleReveal, flashState = "none", flashOpacity, betLabel, actionLabel, pulseKey }: Props) => {
