...
export default function TexasHoldemTab() {
  ...
  async function resetAll() {
    // Reset settings and start new session
    setSettings(s => ({ ...s, numPlayers: 6, bigBlind: 2 }));
  ...
  return (
    <>
      <ScrollView contentContainerStyle={styles.screen}>
        ...
        {/* Feedback row: always visible when Show why is ON */}
        ...
        <View style={styles.footerRow}>
          <Text style={styles.helper}>Educational trainer with multiple AI personalities.</Text>
        </View>
      </ScrollView>
