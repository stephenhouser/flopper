 ...
 * - Fade timing follows feedback time: fade begins at 3/4 of delay, lasts remaining 1/4
 */
        ...
        <Animated.View
          ...
          style={[
            styles.rowOverlay,
            {
              ...
              backgroundColor: heroFlash === "correct" ? "#b9efd2" : "#f8c7cc", // green / red tint
            },
          ]}
        />
      )}
        ...
        <View style={styles.statsRow}>
          <View style={styles.statsLeft}>
            <Text style={styles.feedbackText}>
              {result || "Take an action to see feedback here."}
            </Text>
            <Text style={styles.feedbackSub}>
              Basis: Chen heuristic with table-size & facing-raise adjustments.
            </Text>
          </View>
          ...
          <View style={[styles.controlBlock, { width: "100%" }]}>
            ...
            <View style={[styles.stepper, { justifyContent: "flex-start" }]}>
              <RowButton
                label={<Text>-</Text>}
                onPress={() =>
                  setFeedbackSecs((s) => Math.max(0, parseFloat((s - 0.5).toFixed(1))))
                }
              />
              ...
              <RowButton
                label={<Text>+</Text>}
                onPress={() =>
                  setFeedbackSecs((s) => Math.min(10, parseFloat((s + 0.5).toFixed(1))))
                }
              />
            </View>
